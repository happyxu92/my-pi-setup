...
- Treat .adversarial-loop as loop bookkeeping, not as a requested deliverable. Do not modify loop bookkeeping or another agent's directory. Save task-related scratch notes and other non-deliverable intermediate artifacts only in the supplied generator directory.
